...
const _truckCatalogue = [
  {
    ...
    'cap_kg': 750,
    'category': 'part_load',
    'img': 'assets/images/tata_ace.png',
  },
  {
    'id': 'bolero_8ft',
    'name': 'Bolero • 8ft',
  ...
  },
  {
    ...
    'cap_kg': 2000,
    'category': 'part_load',
    'img': 'assets/images/open_small.png',
  },
  {
    'id': 'open_14ft',
    'name': 'Open • 14ft',
    ...
    'cap_kg': 4000,
    'category': 'part_load',
    'img': 'assets/images/open_medium.png',
  },
  {
    'id': 'open_17ft',
    'name': 'Open • 17ft',
    ...
    'cap_kg': 7000,
    'category': 'full_load',
    'img': 'assets/images/open_large.png',
  },
  {
    'id': 'open_20ft',
    'name': 'Open • 20ft',
  ...
  },
  {
    ...
    'cap_kg': 5000,
    'category': 'full_load',
    'img': 'assets/images/container_large.png',
  },
  {
    'id': 'container_20ft',
    'name': 'Container • 20ft',
...
class _TSignupScreenState extends State<TSignupScreen> {
  ...
  Future<void> _submit() async {
    ...
    final trucks = _truckCatalogue
        .where((t) => _selectedTrucks.contains(t['id']))
        .map(
          (t) => {
            'truck_label': t['name'],
            'truck_type': t['id'],
            'load_category': t['category'],
    ...
    final res = await AuthService.signUpTransporter(
      ...
      operatingFrom: _operatingFrom!,
      operatingCities: _operatingCities.toList(),
    ...
    switch (_step) {
      ...
      case 1:
        if (_selectedLoadType == null) {
          setState(() => _error = 'Please select a load type.');
          return false;
        }
        return true;
      case 2:
        if (_operatingFrom == null) {
          setState(() => _error = 'Please select your base city.');
          return false;
        }
        if (_operatingCities.isEmpty) {
          setState(() => _error = 'Please select at least one operating city.');
          return false;
        }
        return true;
      case 3:
        if (_selectedTrucks.isEmpty) {
          setState(() => _error = 'Please select at least one truck.');
          return false;
        }
        return true;
    }
      ...
      for (final lt in [
        {
          ...
          'icon': '📦',
          'label': 'Part Load',
          'desc': 'Shared truck space — smaller shipments',
        },
        {
          'id': 'full_load',
          'icon': '🚛',
          'label': 'Full Load',
          'desc': 'Entire truck booked for one shipment',
        },
        {
          'id': 'both',
          'icon': '⚡',
          'label': 'Both',
          'desc': 'Accept both part & full load shipments',
        },
      ]) ...[
        GestureDetector(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: _selectedLoadType == lt['id']
                    ...
                    : AppColors.border,
                width: _selectedLoadType == lt['id'] ? 2 : 1,
              ),
            ),
            child: Row(
              children: [
  ...
  Widget _buildStep3() {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 4),
        Text(
          'Where do you operate from and deliver to?',
          style: GoogleFonts.inter(
            fontSize: 13,
            color: AppColors.textSecondary,
          ),
        ...
        Text(
          'Operating Cities (Delivery destinations)',
          style: GoogleFonts.inter(
            fontSize: 13,
            fontWeight: FontWeight.w600,
            color: AppColors.textPrimary,
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        allSelected
                            ? 'All ${_allCities.length} cities selected'
                            : 'Operate across all of India — select all cities',
                        style: GoogleFonts.inter(
                          fontSize: 12,
                          color: allSelected
                ...
                Container(
                  ...
                  child: Icon(
                    allSelected ? Icons.check_rounded : Icons.add_rounded,
                    color: Colors.white,
                    size: 14,
                  ),
                ),
        ...
        Wrap(
          ...
          children: _allCities.map((city) {
            ...
            return GestureDetector(
              onTap: () => setState(
                () => sel
                    ? _operatingCities.remove(city)
                    : _operatingCities.add(city),
              ),
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: sel ? AppColors.primaryAmber : AppColors.border,
                  ),
                ),
                child: Text(
                  city,
        ...
        if (_operatingCities.isNotEmpty && !allSelected) ...[
          const SizedBox(height: 10),
          Text(
            '${_operatingCities.length} cities selected',
            style: GoogleFonts.inter(
              fontSize: 12,
              fontWeight: FontWeight.w700,
              color: AppColors.primaryAmber,
  ...
  Widget _buildStep4() => Column(
    ...
    children: [
      ...
      const SizedBox(height: 4),
      Text(
        'Select all trucks you own and operate',
        style: GoogleFonts.inter(fontSize: 13, color: AppColors.textSecondary),
      ),
      const SizedBox(height: 24),
      GridView.builder(
        ...
        itemBuilder: (_, i) {
          ...
          return GestureDetector(
            onTap: () => setState(
              () => sel ? _selectedTrucks.remove(id) : _selectedTrucks.add(id),
            ),
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: t['category'] == 'part_load'
                          ? AppColors.navyLight
                          : AppColors.greenLight,
                      borderRadius: BorderRadius.circular(100),
                    ),
                    child: Text(
                      t['category'] == 'part_load' ? 'Part' : 'Full',
                      style: GoogleFonts.inter(
                        fontSize: 9,
                        fontWeight: FontWeight.w700,
                        color: t['category'] == 'part_load'
      ...
      if (_selectedTrucks.isNotEmpty) ...[
        ...
        Text(
          '${_selectedTrucks.length} truck(s) selected',
          style: GoogleFonts.inter(
            fontSize: 12,
            fontWeight: FontWeight.w700,
            color: AppColors.primaryAmber,
            ...
            children: [
              ...
              Text(
                ...
                style: GoogleFonts.inter(
                  fontSize: 9,
                  fontWeight: FontWeight.w600,
                  color: active ? AppColors.primaryNavy : AppColors.textMuted,
                ),
              ),
            ],
          );
