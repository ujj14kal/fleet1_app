                    ...
                    if (_transporter != null) ...[
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            _BannerChip(
                              label: _transporter!.loadTypeLabel,
                              icon: Icons.local_shipping_rounded,
                            ),
                            const SizedBox(width: 16),
                            _BannerChip(
                              label: _transporter!.operatingFrom ?? '—',
                ...
                delegate: SliverChildListDelegate([
                  ...
                  if (_loading)
                    const Padding(
                      ...
                      child: Center(
                        child: TruckLoader(message: 'Loading assignments...'),
                      ),
                    )
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            'Our ops team will assign shipments matching your routes',
                            style: GoogleFonts.inter(
                              fontSize: 12,
                              color: AppColors.textMuted,
                            ),
